 ...
 * onPress (or a success alert that then navigates) never runs. These helpers
 * fall back to window.confirm / window.alert on web and use the native Alert on
 * device, so every button works whether the demo runs in Expo Go or a browser.
 */
